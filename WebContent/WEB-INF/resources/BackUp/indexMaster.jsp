...
<%--   <script type="text/javascript" src="<c:url value="/webjars/jquery/1.9.1/jquery.min.js"/>"></script>
  ...
  <link rel="stylesheet" href="<c:url value="/webjars/font-awesome/5.9.0/css/all.css"/>"> --%>
...
<body onload="afterPageLoad('MATCH')">
	<div class="content py-5" style="background-color:#EAE8FF;color:#2E008B;">
		<div class="container">
			<div class="panel-group" id="match_wagon_shots_menu" role="tablist" aria-multiselectable="true">
			  <div class="panel panel-default" id="match-panel">
			    <div class="panel-heading" role="tab" id="match_heading" style="border-style:solid;border-width:medium;border-radius:25px;">
			      <h5 class="panel-title" style="position:relative;left:10px;">
			        <a data-toggle="collapse" data-parent="#match_wagon_shots_menu" href="#match_sub_menu" aria-expanded="true"  
			        	aria-controls="match_sub_menu"> Match 
			        </a>
			      </h5>
			    </div>
			    <div id="match_sub_menu" class="panel-collapse collapse" role="tabpanel" aria-labelledby="match_heading">
